...
const CasualtiesSchema = new Schema({
  description: { type: String, default: '' },
  statistics: { type: [Schema.Types.Mixed], default: [] } // Mixed because stats could be numbers, objects, etc.
}, { _id: false });
...
const EventSchema = new Schema({
  ...
  coreInfo: {
    ...
    startingDate: { type: Date }, // store as Date
    endDate: { type: Date },
  ...
  mainNarrative: {
    ...
    // Flexible timeline items — modelled as array of objects with optional fields
  ...
  analysisAndInterpretation: {
    ...
    sourcesAndReading: {
      primarySources: { type: [Schema.Types.Mixed], default: [] }, // allow flexible primary source objects or URLs
